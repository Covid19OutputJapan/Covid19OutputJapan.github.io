...
if iPC==1
    ...
    CurrentD = load('/Users/shotaro/Dropbox/fujii_nakata/Website/Codes/Japan20210928.mat');
end
if iPC == 1
...
weekdiff = 2; %marker fot Tdata - weekdiff
...
for l = 1:2
    ...
    subplot(2,3,1)
    plot(StartDateF:(Tdata),dNForecast(StartDateF:Tdata-2,1),'r',StartDateF:(Tdata),dNActual(StartDateF:Tdata,1),'k','LineWidth',1.5)
    hold on
    plot(Tdata,dNForecast(Tdata, 1),'or','MarkerFaceColor','r', 'MarkerSize', markersize);
    hold on
    plot((Tdata-weekdiff),dNForecast(Tdata-weekdiff, 1),'or','MarkerFaceColor','r', 'MarkerSize', markersize);
    if l == 1
    ...
    subplot(2,3,2)
    plot(StartDateF:(Tdata),dDForecast(StartDateF:Tdata-2,1),'r',StartDateF:(Tdata),dDActual(StartDateF:Tdata,1),'k','LineWidth',1.5)
    hold on
    plot(Tdata,dDForecast(Tdata, 1),'or','MarkerFaceColor','r', 'MarkerSize', markersize);
    hold on
    plot((Tdata-weekdiff),dDForecast(Tdata-weekdiff, 1),'or','MarkerFaceColor','r', 'MarkerSize', markersize);
    if l == 1
    ...
    subplot(2,3,3)
    plot(StartDateF:(Tdata),ICUForecast(StartDateF:Tdata-2,1),'r',StartDateF:(Tdata),ICUActual(StartDateF:Tdata,1),'k','LineWidth',1.5)
    hold on
    plot(Tdata,ICUForecast(Tdata, 1),'or','MarkerFaceColor','r', 'MarkerSize', markersize);
    hold on
    plot((Tdata-weekdiff),ICUForecast(Tdata-weekdiff, 1),'or','MarkerFaceColor','r', 'MarkerSize', markersize);
    if l == 1
    ...
    subplot(2,3,4)
    plot(StartDateF:(Tdata),dNForecast(StartDateF:Tdata-2,1)-dNActual(StartDateF:Tdata,1),'k','LineWidth',1.5)
    hold on
    plot(Tdata,dNForecast(Tdata,1)-dNActual(Tdata,1),'ok','MarkerFaceColor','k', 'MarkerSize', markersize);
    hold on
    plot((Tdata-weekdiff),dNForecast(Tdata-weekdiff,1)-dNActual(Tdata-weekdiff,1),'ok','MarkerFaceColor','k', 'MarkerSize', markersize);
    if l == 1
    ...
    subplot(2,3,5)
    plot(StartDateF:(Tdata),dDForecast(StartDateF:Tdata-2,1)-dDActual(StartDateF:Tdata,1),'k','LineWidth',1.5)
    hold on
    plot(Tdata,dDForecast(Tdata,1)-dDActual(Tdata,1),'ok','MarkerFaceColor','k', 'MarkerSize', markersize);
    hold on
    plot((Tdata-weekdiff),dDForecast(Tdata-weekdiff,1)-dDActual(Tdata-weekdiff,1),'ok','MarkerFaceColor','k', 'MarkerSize', markersize);
    if l == 1
    ...
    hold on
    plot((Tdata-weekdiff),ICUForecast(Tdata-weekdiff,1)-ICUActual(Tdata-weekdiff,1),'ok','MarkerFaceColor','k', 'MarkerSize', markersize);
    if l == 1
...
if data_save == 1
    ...
    writetable(FET,'/Users/shotaro/Dropbox/fujii_nakata/Website/Codes/Figures/ForecastTable.xls','WriteVariableNames',false);
end
