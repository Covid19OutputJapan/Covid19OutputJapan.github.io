...
if iPC==1
    ...
    CurrentD = load('\Users\shcor\Dropbox\fujii_nakata\Website\Codes\Japan20210413.mat');
else
    load('/Users/ymaeda/Dropbox/fujii_nakata/Website/Codes/Forecast.mat')
    CurrentD = load('/Users/ymaeda/Dropbox/fujii_nakata/Website/Codes/Japan20210518.mat');
end
...
if figure_save == 1
    saveas(figure(10),'/Users/ymaeda/Dropbox/fujii_nakata/Website/Codes/Figures/ForecastErrors.png');
    saveas(figure(101),'/Users/ymaeda/Dropbox/fujii_nakata/Website/Codes/Figures/ForecastErrors_jp.png');
end
...
if data_save == 1
    ...
    writetable(FET,'/Users/ymaeda/Dropbox/fujii_nakata/Website/Codes/Figures/ForecastTable.xls','WriteVariableNames',false);
end