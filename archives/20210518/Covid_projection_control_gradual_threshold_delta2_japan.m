function [CumD,GDPLoss,SimData,SimN] = Covid_projection_control_gradual_threshold_delta2_japan(InitialValues,beta,gamma,delta,delta_ss,delta_average,V,h,k,POP0,hconstant,alpha_duration)
