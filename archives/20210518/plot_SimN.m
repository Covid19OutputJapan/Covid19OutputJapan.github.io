function [BackDataN, BackDataAlpha, BackDataERN]...
    = plot_SimN(TH,TH_index,N,NPath,alpha,AlphaPath,ERN,SimERN,THonPath,MonthWeekEN,MonthWeekJP,WeekNumber,Tdata,linecolor,fs,fn,ft,l)
...
plot([nan(length(N),1);THonPath(:,i)]/7,'k','LineWidth',0.1,'HandleVisibility','off')
