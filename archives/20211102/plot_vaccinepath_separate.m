function plot_vaccinepath_separate(panelnum,VT,V1_medical,V2_medical,V1_elderly,V2_elderly,V1_others,V2_others,ps,MonthWeek,WeekNumber,Tdata,fs,ldfs,fn, x_left, x_right, l)
...
%     ylabel('累計ワクチン接種本数（億本）','FontName',fn)
    if l == 2
        ...
        title('累計接種本数(全国換算;億)', 'FontSize',fs,'FontWeight','normal','FontName',fn);
    else
        ...
        title('Cumulative(Converted to the national level; 100 million doses)', 'FontSize',fs,'FontWeight','normal','FontName',fn);
    end
end
