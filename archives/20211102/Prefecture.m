...
ICU_nation(end) = 56; %Update Saturday values from Tokyo website : https://www.fukushihoken.metro.tokyo.lg.jp/iryo/kansen/corona_portal/info/kunishihyou.html
...
state = 0;
TH = [7000 * 7, 7000 * 7, 7000 * 7, 7000 * 7];
TH_index = TH;

th_off = 1000 * 7;
beta_goal_vec = [1.7588, 2.1984, 2.9313, 3.5175]; %beta_goal_vec % 3:1.2634 % 5: 2.1057 % 6: 2.5268
scale_beta = 1.2;
