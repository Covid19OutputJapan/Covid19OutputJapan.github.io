...
if PF == 0  % AZ
    ...
    E2 = 0.75; %感染予防効果減退を考慮 ... (0.85 + 0.80 + 0.85)/3  = 0.8333 Mean value of ICL, LSHTM, and Warwick assumpitons for the reducito in risk of infection
...
D2 = (D1 - E1)/(1-E1);      % Find reduction of death conditoinal on infection after second does
