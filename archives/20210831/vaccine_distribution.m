...
% 
%     deltaT = S_elderly_path/(S_young_path+S_elderly_path) * delta_average * lambda_death;
%     
...
%     delta_ICU_nation = S_elderly_path/(S_young_path+S_elderly_path) * delta_ICU_nation_average * lambda_delta_ICU_nation;
%     
...
%     delta_ICU_pref =  S_elderly_path/(S_young_path+S_elderly_path) * delta_ICU_pref_average * lambda_delta_ICU_pref;
% 
...
%     delta_Hospital =  S_elderly_path/(S_young_path+S_elderly_path) * delta_Hospital_average * lambda_delta_Hospital;
