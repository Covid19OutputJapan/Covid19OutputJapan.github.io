...
th_on_vector2 = [1600,1000,800,700,1500,350,350]; % 高齢者がうち終わったあとの基準

% 緊急事態宣言の解除基準
th_off_vector = [1000,100,110,80,100,50,60]; %1回目の緊急事態宣言の解除基準
...
paces_ori_vec = [6300000,0,0,0,6300000];
...
paces2_ori_vec = [8400000 - paces_ori_vec(1),0,0,0,2000000];
gradual_paces2_vec = [2,0,0,0,2];
