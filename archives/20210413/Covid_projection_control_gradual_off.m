function [CumD,GDPLoss,alphapath,SimData,SimN,SimERN] = Covid_projection_control_gradual_off(InitialValues,alpha_on,alpha_off,th_on,th_off,beta,gamma,delta,V,h,k,POP0,hconstant,alpha_duration,current_alpha)
