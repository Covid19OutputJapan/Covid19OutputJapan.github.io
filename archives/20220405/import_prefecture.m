...
ICU_limit_pref_vec(find(dateEN == datetime(2022,3,3)):find(dateEN == datetime(2022,3,24))-1) = 471;
ICU_limit_pref_vec(find(dateEN == datetime(2022,3,24)):find(dateEN == datetime(2022,3,31))-1) = 460;
ICU_limit_pref_vec(find(dateEN == datetime(2022,3,31)):Tdata) = 437;
...
Hospital_limit_vec(find(dateEN == datetime(2022,3,17)):find(dateEN == datetime(2022,3,24))-1) = 6946;
Hospital_limit_vec(find(dateEN == datetime(2022,3,24)):find(dateEN == datetime(2022,3,31))-1) = 6922;
Hospital_limit_vec(find(dateEN == datetime(2022,3,31)):Tdata) = 6851;
