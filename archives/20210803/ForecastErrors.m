...
if iPC==1
    ...
    CurrentD = load('/Users/koheimachi/Dropbox/fujii_nakata/Website/Codes/Japan20210727.mat');
end
if iPC == 1
...
if figure_save == 1
    saveas(figure(10),'/Users/kenic/Dropbox/fujii_nakata/Website/Codes/Figures/ForecastErrors.png');
    saveas(figure(101),'/Users/kenic/Dropbox/fujii_nakata/Website/Codes/Figures/ForecastErrors_jp.png');
end
...
if data_save == 1
    ...
    writetable(FET,'/Users/kenic/Dropbox/fujii_nakata/Website/Codes/Figures/ForecastTable.xls','WriteVariableNames',false);
end
