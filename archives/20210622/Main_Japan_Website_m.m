...
close all
iPC= 1;
home = 'C:\Users\kenic\Dropbox\fujii_nakata\Website\Covid19OutputJapan.github.io\archives\20210622\';
% if iPC == 1
...
ind_date = find(date_long == datetime(2021,7,15));
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if iPC==1
  NextD = load('\Users\kenic\Dropbox\fujii_nakata\Website\Codes\Japan20210629.mat');
