...
if iPC==1
    ...
    CurrentD = load('C:\Users\kenic\Dropbox\fujii_nakata\Website\Codes\Japan20210713.mat');
else
    load('/Users/koheimachi/Dropbox/fujii_nakata/Website/Codes/Forecast.mat')
    CurrentD = load('/Users/koheimachi/Dropbox/fujii_nakata/Website/Codes/Japan20210608.mat');
end
if iPC == 1
...
if figure_save == 1
    saveas(figure(10),'C:/Users/kenic/Dropbox/fujii_nakata/Website/Codes/Figures/ForecastErrors.png');
    saveas(figure(101),'C:/Users/kenic/Dropbox/fujii_nakata/Website/Codes/Figures/ForecastErrors_jp.png');
end
...
if data_save == 1
    ...
    writetable(FET,'C:/Users/kenic/Dropbox/fujii_nakata/Website/Codes/Figures/ForecastTable.xls','WriteVariableNames',false);
end
