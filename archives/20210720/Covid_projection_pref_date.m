...
% alpha_off_path = alpha_on+(alpha_off-alpha_on)*alpha_jump:(1-alpha_jump)*((alpha_off-alpha_on)/(alpha_duration)):alpha_off;
...
alphapath(1:5) = alpha_on;
alphapath(6:6+alpha_duration) = alpha_off_path;
