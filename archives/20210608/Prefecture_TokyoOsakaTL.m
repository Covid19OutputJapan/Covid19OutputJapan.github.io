...
for iTH = 1:length(TH)
    ...
    if vaccine_figure_loop == 0
        ...
        if iTH == 1
            ...
            %                 plot_vaccinepath_ym(200,VT,V1_medical,V2_medical,V1_elderly,V2_elderly,date,1,MonthWeekJP,WeekNumber,Tdata,fs,ldfs,fn);
    ...
    elseif vaccine_figure_loop == 1
        ...
        %             plot_vaccinepath_ym(200+iTH,VT,V1_medical,V2_medical,V1_elderly,V2_elderly,date,1,MonthWeekJP,WeekNumber,Tdata,fs,ldfs,fn);
        subplot(1, 2, 1)
