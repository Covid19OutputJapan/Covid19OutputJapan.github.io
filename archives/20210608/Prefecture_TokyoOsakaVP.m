...
% ==================== CHANGE HERE ====================== %
% ======================================================= %
xline_ind = find(date == '17-Jun-2021'); % when the state of emergency end
% xline_ind = find(date == '2021/06/17'); % when the state of emergency end

%ind_date = [find(date == '2021/07/22')]; %Date by which the first shots should finish
...
sw_vacpath_vec = [0,0];
ind_date_vec = [find(date == '22-Jul-2021'),find(date == '1-Jul-2021')]; %Date by which the first shots should finish
% ind_date_vec = [find(date == '2021/07/22'),find(date == '2021/07/01')]; %Date by which the first shots should finish
