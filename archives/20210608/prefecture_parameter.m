...
% 緊急事態宣言の解除基準
th_off_vector = [300,100,110,80,100,50,60]; %1回目の緊急事態宣言の解除基準
th_off_vector2 = [300,100,80,60,100,50,60]; %2回目の緊急事態宣言の解除基準
th_off_vector3 = [300,100,80,60,100,50,60]; %3回目の緊急事態宣言の解除基準

% 緊急事態宣言の強さの基準: Simulation開始時のERNをいくつにするか
alpha_on_vector = [0.2,0.1,0.1,0.1,0.2];
% Size of AR(1) shock for beta process
betaT_temp_ini_vec = [-0.3,0,0,0,-0.5,0,0,0];%-0.1
