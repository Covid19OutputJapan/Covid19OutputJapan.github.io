...
if ifig == 1
    ...
    if l == 2
        plot(CV1, "k", "DisplayName", "2本目累計", "LineWidth", 0.5)
        hold on
        plot(CV2, "k", "DisplayName", "3本目累計",  "LineWidth", 1.5)
        lgd = legend;
        ...
        plot(CV1, "k", "DisplayName", "Second Dose", "LineWidth", 0.5)
        hold on
        plot(CV2, "k", "DisplayName", "Third Dose",  "LineWidth", 1.5)
        lgd = legend;
        lgd.Location = "Northwest";
