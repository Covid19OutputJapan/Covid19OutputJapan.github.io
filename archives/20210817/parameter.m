...
RetroPeriodHospital = 3; %13; %17;      % retroactive periods used to estimate delta_Hospital (Hospital)
...
beta_goal_vec = [0.9304, 1.2304, 1.7304];%[0.9304, 1.2304, 1.6304]; % [sd = -1.5, sd = 0, sd = 1.5]
