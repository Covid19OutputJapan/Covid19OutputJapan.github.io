function [delta_wo_alpha, delta_wo_vaccination, delta_ICU_nation_wo_vaccination, ...
...
delta_wo_alpha = delta_wo_vaccination /(1+var_infection); %Eliminate the effects of alpha variant in the past average value
delta_ICU_nation_wo_alpha = delta_ICU_nation_wo_vaccination /(1+var_infection);
delta_ICU_pref_wo_alpha = delta_ICU_pref_wo_vaccination /(1+var_infection);
delta_Hospital_wo_alpha = delta_Hospital_wo_vaccination /(1+var_infection);
