...
ind_date_vec = [find(date == datetime(2021,7,29)),find(date == datetime(2021,7,29)),find(date == datetime(2021,7,29))]; %Date by which the first shots should finish
% vaccine paces for shokuiki 
total_shots_vec = [8400000,7000000,9800000]; 
paces2_ori_vec = total_shots_vec - TH;
gradual_paces2_vec = [1,1,2];
