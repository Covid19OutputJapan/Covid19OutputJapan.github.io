...
for pindex = 1:5
    ...
    var_initial_vector(pindex) = var_share(2); %var_share(2) for Monday or var_share(1) after Wednesday
end
%=====================================================%
...
%     TH2_index = [0.3, 0.5];
    ...
    TH = var_infection_vec;
    TH_index = var_infection_vec;
