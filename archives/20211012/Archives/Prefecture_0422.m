...
SimCases=1; % 1 = Different thresholds (ON/OFF); 2 = Different durations for economic recovery ; 3 = different vaccine policy; 4 = different infection rate
...
ERN_on_vector = [0.9,0.99,1.00,0.99,0.85,0.97,1.02]; %baseline scenario
ERN_on_scenario1 = [0.8,0.8,0.8,0.8,0.8,0.8,0.8]; %beta_option = 41
ERN_on_scenario2 = [0.5,0.5,0.5,0.5,0.5,0.5,0.5]; %beta_option = 42

% Used for SimCases = 1: different threshold for lifting the state of emergency
...
for pindex = 1:5
    ...
    var_initial_vector(pindex) = var_share(2);
end
%=====================================================%
disp(var_initial_vector) %[0.2195, 0.2234, 0.0663, 0.2624, 0.8153, 0, 0, 0,0]; % 4/19
...
beta_option_index = [1]; %{1,3,41,42} 1 ... baseline, 3 ... 気の緩み,
...
%             end
            ...
            for y = SimCases % Choose which analysis you want
                if y == 1
