...
% for pindex = [1] %:length(PrefVector) %change this parameter for prefecture
    ...
    sw_vacpath_vec = [0,0];
    ind_date_vec = [find(date == '5-Aug-2021'),find(date == '1-Jul-2021')]; %Date by which the first shots should finish
    VT3share_vec = [0.5,0.55];
    lag_vec = [3,3];
    medical_duration_vec = [2,2];
...
%         xlim([20 Tdata])
    ...
    %figure(figname)
    figure('Name',[figname_main char("Alpha_") lng])
    set(gcf,'Position',[100,100,1200,800])
    subplot(2,2,1)
