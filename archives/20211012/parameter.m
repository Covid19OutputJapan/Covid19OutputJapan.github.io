...
RetroPeriodICU_pref = 8; %2; % retroactive periods used to estimate delta_ICU_pref (Tokyo standard Severe case)
RetroPeriodICU_nation = 8; %2;      % retroactive periods used to estimate delta_ICU_nation (National standard Severe case)
RetroPeriodHospital = 8; %13; %2;      % retroactive periods used to estimate delta_Hospital (Hospital)

lambda_delta = 0.5 * 0.95; %0.95;
lambda_delta_ICU_nation = 0.6 * 0.75; %0.5; %0.825
lambda_delta_ICU_pref = 0.7 * 0.75; %0.5; %0.825
lambda_delta_Hospital = 0.7 * 0.75; %0.5; %0.825
vac_end_date = 27;
...
if PF == 0  % AZ
    ...
    %基本 or 希望
    E1 = 0.45;  
    E2 = 0.75; %感染予防効果減退を考慮 %E2 = 0.815; from SPI_M_O Sep 7th
    D1 = 0.865; 
    D2 = 0.96; 
...
%seasonal_effect = 0.2;   % degree of seasonality
