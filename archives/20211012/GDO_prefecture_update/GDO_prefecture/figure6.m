...
for pindex = 1:47%:length(PrefVector)
    ...
    if pindex == 41
        ...
        legend('Fujii-Nakata GDP','Average of Production-side and Expenditure-side output','Production-side output ','Expenditure-side output','FontSize',13,'Location','southeast');
