...
for pindex = 1:47%:length(PrefVector)
    ...
    if pindex == 41
        ...
        hold on
        plot(TDB,'m:','LineWidth',1.5) %3つ目'k-.',
        hold on
        plot(Malt,'c:','LineWidth',1.5) %４つ目'b-.',
        ...
        legend('Conveni(L axis)','TDB(L axis)','Malt(L axis)','Forecasted GDO AR1 (R axis)', 'Data Fujii (R axis)','Data GDO (R axis)','FontSize',13,'Location','southeast');
