...
for pindex = 41:41%:length(PrefVector)
    ...
    Data_cell = {Fujii,Malt,Trav,Event,Rest,Job,Eventinfo,Travelinfo,Movieinfo,TDB,Depart,Conveni,Lag};
    ...
    VarVector_use = {'Fujii','Malt','Trav','Event','Rest','Job','Eventinfo','Travelinfo','Movieinfo','TDB','Depart','Conveni','Lag'};
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 1    
        ...
        yyaxis left
        hold on
        plot(Conveni,'k:+','LineWidth',1.5) %２つ目'g-.',
        hold on
        plot(Depart,'k:s','LineWidth',1.5) %４つ目'b-.',
        ylabel('Normalized index of each variable','Color','k')
        ...
        ylabel('Index for Fujii-Nakata GDP','Color','k')
        xticks(xtick1)

        xticklabels(xticklabel1)

        legend('Conveni(L axis)', 'Depart(L axis)','Fujii-Nakata GDP(R axis)','FontSize',13,'Location','southeast');
        
        
        xlabel('year(last two digits)+month','FontSize',10,'FontName',fn)
        title("+2month data",'FontSize',10,'FontWeight','normal')
        ax = gca;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 2
        ...
        yyaxis left
        hold on
        plot(Event,'k:+','LineWidth',1.5) %２つ目'g-.',
        hold on
        plot(Fujii,'k:o','LineWidth',1.5) %3つ目'k-.',
        hold on
        plot(TDB,'k:*','LineWidth',1.5) %４つ目'b-.',
        hold on
        plot(Trav,'k:s','LineWidth',1.5) %４つ目'b-.',
        ylabel('Normalized index of each variable','Color','k')

        yyaxis right
        hold on
        plot(GDO,'k-','LineWidth',1.5) 
        ...
        legend('Event(L axis)','Production-side output(L axis)','TDB Confidence index(L axis)', 'Travel(L axis)','Fujii-Nakata GDP(R axis)','FontSize',13,'Location','southeast');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        yyaxis left
        hold on
        plot(Eventinfo,'k:+','LineWidth',1.5) %２つ目'g-.',
        hold on
        plot(Movieinfo,'k:o','LineWidth',1.5) %3つ目'k-.',
        hold on
        plot(Travelinfo,'k:*','LineWidth',1.5) %４つ目'b-.',
        hold on
        ylabel('Normalized index of each variable','Color','k')
        ...
        legend('Event-info(L axis)','Movie-info(L axis)','Travel-info(L axis)', 'Fujii-Nakata GDP(R axis)','FontSize',13,'Location','southeast');
        
        
        xlabel('year(last two digits)+month','FontSize',10,'FontName',fn)
        title("+3month data",'FontSize',10,'FontWeight','normal')
        ax = gca;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        yyaxis left
        hold on
        plot(Job,'k:+','LineWidth',1.5) %２つ目'g-.',
        hold on
        plot(Malt,'k:o','LineWidth',1.5) %3つ目'k-.',
        hold on

        plot(Rest,'k:s','LineWidth',1.5) %４つ目'b-.',
        ...
        legend('Job offer(L axis)','Mobility(L axis)', 'Restaurant(L axis)','Fujii-Nakata GDP(R axis)','FontSize',13,'Location','southeast');
        
        
        xlabel('year(last two digits)+month','FontSize',10,'FontName',fn)
        title("+4month data",'FontSize',10,'FontWeight','normal')
        ax = gca;
