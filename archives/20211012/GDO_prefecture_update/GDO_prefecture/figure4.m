...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 1    
        ...
        hold on
        plot(Cred,'k:o','LineWidth',1.5) %3つ目'k-.',
        hold on
        plot(Credserv,'k:*','LineWidth',1.5) %４つ目'b-.',
        hold on
        ...
        legend('Conveni(L axis)','Credit(L axis)','Credit-service(L axis)', 'Depart(L axis)','Fujii-Nakata GDP(R axis)','FontSize',13,'Location','southeast');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        hold on
        plot(Pos,'k:*','LineWidth',1.5) %４つ目'b-.',
        hold on
        ...
        legend('Job offer(L axis)','Mobility(L axis)','Pos(L axis)', 'Restaurant(L axis)','Fujii-Nakata GDP(R axis)','FontSize',13,'Location','southeast');
