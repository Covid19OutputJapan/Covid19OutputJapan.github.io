...
ICU_adjustment = 0.9; %1; %0.8

% Indian Variant Parameters
var_initial2 = 0.50;
var_growth2 = 0.75;     % weekly growth parameter for logit model
var_infection2 = 1.2*0.99 - 1; %0.2; % relative infection rate for delta variant compared to alpha variant
var_infection_delta2 = 0; % relative increase of death rate for delta variant compared to alpha variant
