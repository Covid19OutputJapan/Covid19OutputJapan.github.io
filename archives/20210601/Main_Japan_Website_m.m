...
if Vsimple == 0
    ...
    [V,deltaT,VT] = vaccine_distribution_medical_ori(vacpath,medical,V1_medical,V2_medical,elderly,V1_elderly,V2_elderly, ordinary,elderly_total,delta_average,E1,E2,D1,D2,ps,POP0,lag,medical_duration);
else
