...
th_on_vector2 = [1750,1000,800,700,2250,350,350]; % 高齢者がうち終わったあとの基準

% 緊急事態宣言の解除基準
th_off_vector = [500,100,110,80,100,50,60]; %1回目の緊急事態宣言の解除基準
th_off_vector2 = [500,100,80,60,100,50,60]; %2回目の緊急事態宣言の解除基準
th_off_vector3 = [500,100,80,60,100,50,60]; %3回目の緊急事態宣言の解除基準

% 緊急事態宣言の強さの基準: Simulation開始時のERNをいくつにするか
alpha_on_vector = [0.2,0.1,0.1,0.1,0.2];
% Size of AR(1) shock for beta process
betaT_temp_ini_vec = [0,0,0,0,-0.6,0,0,0];%-0.1
start_beta_vec = [1,1,1,1,1];
beta_rho_vec = [0.5,0,0,0,0.8];
