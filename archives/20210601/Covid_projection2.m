function [CumD,GDPLoss,SimData,SimN,SimICU] = Covid_projection2(InitialValues,alpha,beta,gamma,delta,V,h,k,POP0,hconstant,ICU_inflow_avg,gamma_ICU)
...
%         SimN(i) = ((h(1)+h(2)*alpha(i))^k)*beta(i)*SimData(i,1)*SimData(i,2)*(1/POP0);
    ...
    SimICU(i+1) = SimICU(i) + ICU_inflow_avg*delta(i)*SimN(i) - gamma_ICU*SimICU(i) - delta(i)*SimData(i,2);
end
