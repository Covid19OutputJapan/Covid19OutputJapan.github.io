...
ICU_limit_pref_vec(find(dateEN == datetime(2022,2,3)):Tdata) = 377;
...
Hospital_limit_vec(find(dateEN == datetime(2022,2,3)):Tdata) = 6415;

newICU_limit_pref_vec = zeros(Tdata,1);
newICU_limit_pref_vec(1: find(dateEN == datetime(2022,2,3)) ) = 750;
