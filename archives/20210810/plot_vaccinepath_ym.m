function [Vplot, Area_nv, Area_cv] = plot_vaccinepath_ym(fignum,VT,V1_medical,V2_medical,V1_elderly,V2_elderly,V1_others,V2_others,date,ps,MonthWeek,WeekNumber,Tdata,fs,ldfs,fn)
