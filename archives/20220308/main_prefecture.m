...
tic;
if ispc == 1
    HOME        = 'C:\Users\mogura\Dropbox\PC\Documents\GitHub\github_Codes\';
    DATA_PATH   = 'C:\Users\mogura\Dropbox\fujii_nakata\Website\Codes\Data\';
    FIGURE_PATH = 'C:\Users\mogura\Dropbox\fujii_nakata\Website\Codes\Figures\';
...
V1_elderly(vac1stweek:Tdata-1)    = Vtable.elderly_first;
V2_elderly(vac1stweek:Tdata-1)    = Vtable.elderly_second;
V1_others(vac1stweek:Tdata-1)     = Vtable.others_first;
V2_others(vac1stweek:Tdata-1)     = Vtable.others_second;
...
SoE_duration        = find(SimDateEN == datetime(2022, 3, 24)); % まん防 終了
...
%iY
delta_temp_ini_vec = [1.6, 1.5, 1.5];
...
figfolder           = "Baseline"; % Directory for saved figures
