function [CumD,GDPLoss,alphaPath,SimData,SimN,SimERN,SimICU_nation,SimICU_pref,SimHospital,SimNewICU_pref,betaPath,beta_tilde_path,SimBRN] = ...
    Covid_projection_omicron_date(InitialValues,alpha_on,alpha_off,...
    SoE_date,SoE_off_date, betaT,gamma,deltaT,SimICU_nation_rate, SimICU_pref_rate, SimHospital_rate,SimNewICU_pref_rate,h,k,POP0,...
    lagged_cumsumVT1, lagged_cumsumVT2, lagged_cumsumVT3, E1, E2, E3, cum_in_R, ...
    hconstant,DRi, ...
    gamma_ICU_nation, gamma_ICU_pref, gamma_Hospital,gamma_newICU_pref,...
    scale_beta, beta_jump, beta_goal, seasonality, alphaBox, state, simple_beta_avg, past_beta)
...
for t = 1:T    
    beta = betaT_Path(t);
    alpha = alpha_Path(t);
    SimData(t,3) = min(E1 * lagged_cumsumVT1(t) ...
                 + (E2 - E1) * lagged_cumsumVT2(t) ...
                 + (E3 - E2) * lagged_cumsumVT3(t) ...
