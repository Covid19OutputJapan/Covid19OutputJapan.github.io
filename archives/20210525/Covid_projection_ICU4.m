function [CumD,GDPLoss,alphapath,SimData,SimN,SimERN,THonPath,SimICU] = Covid_projection_ICU4(InitialValues,alpha_on,alpha_off,th_on1,th_on2,th_off1,th_off2,th_off3,beta,gamma,delta,delta_init,V,h,k,POP0,hconstant,alpha_duration,state,new_ICU,gamma_ICU)
