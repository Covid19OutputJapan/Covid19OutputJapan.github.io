function [CumD,GDPLoss,alphaPath,SimData,SimN,SimERN,SimICU_nation,SimICU_pref,SimHospital,SimNewICU_pref,betaPath,beta_tilde_path,SimBRN] = ...
    ...
    SoE_date,th_off_N, betaT,gamma,deltaT,SimICU_nation_rate, SimICU_pref_rate, SimHospital_rate,SimNewICU_pref_rate,h,k,POP0,...
...
for t = 1:T    
    ...
    elseif (SimN(t) < th_off_N)  %(SimNewICU_pref(t+1) < th_off) || (SimN(t) < th_off_N)   %(SimN(t) < th_off)
        if state == 1
