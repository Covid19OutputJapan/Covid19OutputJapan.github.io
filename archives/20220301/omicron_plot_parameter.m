...
if figure_save == 1
    saveas(gcf, [dropbox_path 'Figures/' char(pref) '/' char(figfolder) '/' char(figname_beta) '.png']);
end
...
if figure_save == 1
    ...
    saveas(gcf, [dropbox_path 'Figures/' char(pref) '/' char(figfolder) '/' char(figname_beta_tilde) '.png']);
end
...
if figure_save == 1
    ...
    saveas(gcf, [dropbox_path 'Figures/' char(pref) '/' char(figfolder) '/' char(figname_ERN) '.png']);
end
...
if figure_save == 1
    %     saveas(gcf, [home 'Figures/' char(pref) '/' char(figname_ERN) '.png']);
    saveas(gcf, [dropbox_path 'Figures/' char(pref) '/' char(figfolder) '/' char(figname_BRN) '.png']);
end
%%
linecolor_param = ...
            {"r", "k", "b"; ...
...
if figure_save == 1
    saveas(gcf, [dropbox_path 'Figures/' char(pref) '/' char(figfolder) '/' char(figname_delta) '.png']);
end
...
if figure_save == 1
    ...
    saveas(gcf, [dropbox_path 'Figures/' char(pref) '/' char(figfolder) '/' char(figname_ICU_nation) '.png']);
end
...
if figure_save == 1
    %     saveas(gcf, [home 'Figures/' char(pref) '/' char(figname_ICU_nation) '.png']);
    saveas(gcf, [dropbox_path 'Figures/' char(pref) '/' char(figfolder) '/' char(figname_new_ICU_local) '.png']);
end
...
if figure_save == 1
    ...
    saveas(gcf, [dropbox_path 'Figures/' char(pref) '/' char(figfolder) '/' char(figname_ICU_local) '.png']);
end
...
for iX = 1:nX
  ...
  %ここも変更
    if figure_save == 1
        saveas(gcf, [dropbox_path 'Figures/' char(pref) '/' char(figfolder) '/' char(figname_Hospital) '.png']);
    end
