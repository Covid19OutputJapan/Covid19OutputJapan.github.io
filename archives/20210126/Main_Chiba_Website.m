...
pref = 'Chiba';        % prefecture to be analyzed
...
VacPace = 0.05*1.33*0.8*1500000;  % number of vaccinations per week
...
th_on = 350*7;         % threshold to place the state of emergency (daily new infected persons in Tokyo = 2000)
