...
%             plot([1-alpha;1-AlphaPath(:,i)]*100,linecolor{th_wave},'LineWidth',2,'DisplayName',sprintf(ft,TH(i)))
            plot([1-alpha;1-AlphaPath(:,i)]*100,linecolor{i},'LineWidth',2,'DisplayName',sprintf(ft,TH(i)))
        elseif i == 4
            plot([1-alpha;1-AlphaPath(:,i)]*100,'Color',[0.75, 0, 0.75],'LineWidth',1,'DisplayName',sprintf(ft,TH(i)))
        else
            plot([1-alpha;1-AlphaPath(:,i)]*100,linecolor{i},'LineWidth',1,'DisplayName',sprintf(ft,TH(i)))
        end
        th_wave = th_wave + 1;
