...
ICU_limit_pref_vec(find(dateEN == datetime(2021, 7, 08)):find(dateEN == datetime(2021, 8, 26)) - 1) = 392;
ICU_limit_pref_vec(find(dateEN == datetime(2021, 8, 26)):find(dateEN ==datetime(2021, 9, 09)) - 1) = 465;
ICU_limit_pref_vec(find(dateEN == datetime(2021, 9, 09)):Tdata) = 503;
