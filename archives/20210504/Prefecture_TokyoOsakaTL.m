...
%         TH = [100:100:1000,1060];
        ...
        TH_index1 = [500,700,1060]; %[0.3]
        TH1 = [100:100:1000,1060];
            
        alpha_on2 = 1.5*alpha_May;
        TH_index2 = [300,600,1000];
        TH2 = 100:100:1000;
        
        alpha_on_vector_sim = [alpha_on1, alpha_on2];
        TH_vec = {TH1,TH2};
        TH_index_vec = {TH_index1,TH_index2};
        fig_title_vec = ["Alternative","Baseline"];
        data_title_vec = ["Alternative","Baseline"];
