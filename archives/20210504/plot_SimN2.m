function [BackDataN, BackDataAlpha, BackDataERN]...
    = plot_SimN2(TH,TH_index,N,NPath,alpha,AlphaPath,ERN,SimERN,MonthWeekEN,MonthWeekJP,WeekNumber,Tdata,linecolor,fs,fs_legend,fn,ft,l)
...
if l == 1
    ...
    legend('Baseline','Optimistic','FontSize',fs_legend,'Location','southeast');
elseif l == 2
    title('新規感染者数の推移','FontSize',fs,'FontWeight','normal','FontName',fn)
    xticklabels(MonthWeekJP(WeekNumber==1))
    legend('基本見通し','希望見通し','FontSize',fs_legend,'FontName',fn,'Location','southeast');
end
