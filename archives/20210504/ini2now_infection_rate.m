function var_initial_vector = ini2now_infection_rate(var_initial_vector,var_growth,SimPeriod,share_index)
...
for pindex = 1:5
    ...
    var_share = exp((1:SimPeriod)'*var_growth+logit_initial)./(1+exp((1:SimPeriod)'*var_growth+logit_initial));
