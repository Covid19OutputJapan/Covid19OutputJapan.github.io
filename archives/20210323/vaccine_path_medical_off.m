pfunction [V,delta,VT,real_pace] = vaccine_path_medical_off(pace,pace_m,T,medical,elderly,ordinary,medical_start,elderly_start,lag,effectiveness,delta_average,elderly_total)
