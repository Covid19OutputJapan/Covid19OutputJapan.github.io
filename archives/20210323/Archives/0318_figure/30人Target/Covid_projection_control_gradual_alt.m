function [CumD,GDPLoss,alphapath,SimData,SimN,SimERN] = Covid_projection_control_gradual_alt(InitialValues,alpha_now,alpha_on,alpha_off,th_on,th_off,beta,gamma,delta,V,h,k,POP0,hconstant,alpha_duration)
...
% alpha_off_path_on = alpha_on:(alpha_off-alpha_on)/(alpha_duration+1):alpha_off;
counter = 1;
wave = 0;
for i = 1:T
    alphapath(i) = alpha;
