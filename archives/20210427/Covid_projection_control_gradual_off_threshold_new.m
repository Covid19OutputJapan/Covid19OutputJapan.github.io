function [CumD,GDPLoss,alphapath,SimData,SimN,SimERN] = Covid_projection_control_gradual_off_threshold_new(InitialValues,alpha_on,alpha_off,th_on1,th_on2,th_off1,th_off2,beta,gamma,delta,V,h,k,POP0,hconstant,alpha_duration,current_alpha)
