function [CumD,GDPLoss,alphapath,SimData,SimN,SimERN] = Covid_projection_control_gradual_threshold_delta2(InitialValues,alpha_on,alpha_off,th_on1,th_on2,th_off1,th_off2,beta,gamma,delta,delta_ss,delta_th,V,h,k,POP0,hconstant,alpha_duration)
