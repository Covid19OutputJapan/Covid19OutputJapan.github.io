...
RetroPeriodDelta = 4; %17;      % retroactive periods used to estimate delta (Death rate)
RetroPeriodICU_pref = 4; %17; % retroactive periods used to estimate delta_ICU_pref (Tokyo standard Severe case)
RetroPeriodICU_nation = 13; %17;      % retroactive periods used to estimate delta_ICU_nation (National standard Severe case)
RetroPeriodHospital = 13; %17;      % retroactive periods used to estimate delta_Hospital (Hospital)
