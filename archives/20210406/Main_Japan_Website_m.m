...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if iPC==1
  NextD = load('\Users\shcor\Dropbox\fujii_nakata\Website\Codes\Japan20210413.mat');
  FE = load('\Users\shcor\Dropbox\fujii_nakata\Website\Codes\Forecast.mat');
else
  NextD = load('/Users/shotaro/Dropbox/fujii_nakata/Website/Codes/Japan20210413.mat');
