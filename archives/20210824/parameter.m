SimPeriod = 156; % 52;% 208;   %156      % simulation period in weeks
...
RetroPeriodDelta = 4; %2;      % retroactive periods used to estimate delta (Death rate)
RetroPeriodICU_pref = 2; %2; % retroactive periods used to estimate delta_ICU_pref (Tokyo standard Severe case)
