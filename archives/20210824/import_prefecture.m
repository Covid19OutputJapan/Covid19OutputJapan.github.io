...
if iPC==1
    ...
    covid = importdata([home 'Covid_weekly_newV.csv']);  % Import weekly Covid data by prefecture
%     covid = importdata(['/Users/koheimachi/Dropbox/fujii_nakata/Website/Covid19OutputJapan.github.io/archives/20210817/Covid_weekly_NewV.csv']);  % Import weekly Covid data by prefecture
end
