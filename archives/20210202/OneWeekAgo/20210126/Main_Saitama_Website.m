...
VacPace = 0.06*1.33*0.8*1500000;  % number of vaccinations per week
...
th_on = 400*7;         % threshold to place the state of emergency (daily new infected persons in Tokyo = 2000)
